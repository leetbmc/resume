...
\begin{tabular}{rl}
    \textsc{Address:}   & 2343 Yosemite Drive, Los Angeles, California, USA 90041 \\
    \textsc{Phone:}     & +1 408 205 0031\\
    \textsc{email:}     & \href{mailto:bmc.resume@section9.net}{bmc.resume@section9.net}
\end{tabular}

%Section: Work Experience at the top
\section{Professional Experience}
\begin{tabular}{r|p{11cm}}
 \emph{Current} & Sabbatical \\\textsc{September 2015}&\emph{International Travel and Professional Development}\\&\footnotesize{10 monts of domestic and international travel. Thailand, Malaysia, Indonesia, Singapore, Germany, United Kingdom. Certified Divemaster by Professional Association of Dive Instructors, March 2016. Constructed }\\\multicolumn{2}{c}{} \\
